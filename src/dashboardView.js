...
export function renderMacoChart() {
   const canvas = document.getElementById('macoChartCanvas');
            ...
            const labels = trainData.map(t => `Train ${t.id}`);
